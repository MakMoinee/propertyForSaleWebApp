                    ...
                    <div class="simplebar-offset" style="right:0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/agent_profile">
            ...
            <div class="container-lg">
                <div class="row">
                    <div class="col-lg-12">
                        <br>
                        <div class="card lg-4">
                            <form action="/agent_profile/{{ $currentUser['userID'] }}" method="post"
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-4">
                                            <button style="float: right;margin-top: 20px;" type="submit"
                                                class="btn btn-warning text-white" name="btnUpdateAgentProfile"
