                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#register">Register/Login</a></li>
                            <li class="scroll-to-section"><button class="btn btn-danger dangerBtn">List Property</button></li>
                        </ul>
